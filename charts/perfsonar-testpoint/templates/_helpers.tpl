...
{{/*
Shared service ports for the public and headless services.
*/}}
{{- define "perfsonar.servicePorts" -}}
- port: 861
  targetPort: 861
  protocol: TCP
  name: owamp
...
{{- define "perfsonar.pschedulerConfigMapName" -}}
{{- default (printf "%s-pscheduler-d-configmap" .Release.Name) .Values.pschedulerConfigMap.name }}
{{- end }}

{{- define "perfsonar.reloaderConfigMapNames" -}}
{{- include "perfsonar.pschedulerConfigMapName" . -}}
{{- end }}
